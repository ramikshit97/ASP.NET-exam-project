<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deletepaper.aspx.cs" Inherits="deletepaper" %>
    ...
    <table class="style1" align=center>
        ...
        <tr>
            <td bgcolor="#0066ff" class="style14">
                ...
                <MARQUEE class="blink" behavior="alternate" direction="right" scrollamount="10">DELETE QUESTION PAPER</MARQUEE>
                </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" 
                    ...
                    DataValueField="Subject" Height="46px" Width="140px">
                </asp:DropDownList>
                ...
                <asp:Button ID="Button2" runat="server" onclick="Button1_Click" Text="Delete" style="font-weight: 700; font-style: italic; color: #000066; background-color: #00CCFF" />
